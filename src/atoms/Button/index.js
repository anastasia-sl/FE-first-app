...
function Button (props){
    const {backgrndColor, textColor, shadow, borderRadius, border, title, font, children, size, stat, ...baseProps} = props;
